...
train_pipeline = [
    ...
    dict(type="RandomResizedCrop", scale=input_size),
    ...
    dict(
        ...
        min_area_ratio=0.02,
        max_area_ratio=1 / 3,
        fill_color=data_preprocessor["mean"],
        fill_std=data_preprocessor["std"]),
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_prefix=r"D:\Seg_TP\Lake_freeze-thaw\Qinghai_Lake\backscatter_coefficient_dataset\train",
        with_label=True,
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_prefix=r"D:\Seg_TP\Lake_freeze-thaw\Qinghai_Lake\backscatter_coefficient_dataset\val",
        with_label=True,
